...
function createTable(amountOfRows, filteredStudents){
    ...
    for (let i = 0; i < amountOfRows; i++) {
        ...
        cell1.innerText = filteredStudents[i].OM_Azonosito; 
        cell2.innerText = filteredStudents[i].Neve; 
        cell3.innerText = filteredStudents[i].Matematika; 
        cell4.innerText = filteredStudents[i].Magyar;
        cell5.innerText = filteredStudents[i].Matematika + filteredStudents[i].Magyar;
